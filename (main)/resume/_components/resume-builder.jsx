...
const ResumeBuilder = ({ initialContent }) => {
    ...
    const generatePDF = async () => {
        ...
        try {
            ...
            document.documentElement.classList.add('resume-export-theme');
            ...
            document.documentElement.classList.remove('resume-export-theme');
        ...
        <div className="space-y-4">
            <div className="flex flex-col md:flex-row justify-between items-center gap-2">
                ...
                <div className="space-x-2">
                    <Button variant="destructive" className="cursor-pointer" onClick={onSubmit} disabled={isSaving}>
                        {isSaving?(
                            <>
                    ...
                    <Button onClick={generatePDF} className="cursor-pointer" disabled={isGenerating}>
                        {isGenerating?(
                            <>
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab}>
                ...
                <TabsContent value="preview">
                    <Button variant="link" type="button" className="mb-2 cursor-pointer" onClick={() => setResumeMode(resumeMode === "preview"?"edit":"preview")}>
                        {resumeMode === "preview" ? (
                            <>
                    ...
                    {resumeMode !== "preview" && (
                        <div className="flex p-3 gap-2 items-center border-2 border-red-400 text-red-400 rounded mb-2">
                    ...
                    <div className="hidden">
                        <div id="resume-pdf" className="resume-export-theme text-black bg-white">
