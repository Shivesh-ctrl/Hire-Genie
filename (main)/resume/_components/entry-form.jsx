           ...
           {isAdding && (
            <Card>
                ...
                <CardContent className="space-y-4">
                    ...
                    <Button type="button" className="cursor-pointer" variant="ghost" size="sm" onClick={handleImproveDescription} disabled={isImproving || !watch("description")}>
                        {isImproving ? (
                            <>
                ...
                <CardFooter className="flex justify-end space-x-2">
                    <Button type="button" className="cursor-pointer" variant="outline" onClick={() => {
                        reset();
                        setIsAdding(false);
                    }}>Cancel</Button>
